...
CONTAINS
  ...
  SUBROUTINE Update_My_IMEX_PDARS &
    ( dt, U_R, Explicit_Option, Implicit_Option, &
    ...
    !$OMP MAP( to: U_R, uGE, uGF ) &
    !$OMP MAP( alloc: U0_R, T0_R, T1_R, Q1_R )
#elif defined(THORNADO_OACC)
    !$ACC ENTER DATA &
    !$ACC COPYIN( U_R, uGE, uGF ) &
    !$ACC CREATE( U0_R, T0_R, T1_R, Q1_R )
#endif
...
#if defined(THORNADO_OMP_OL)
    !$OMP TARGET UPDATE FROM( T0_R, T1_R, Q1_R )
#elif defined(THORNADO_OACC)
    !$ACC UPDATE HOST( T0_R, T1_R, Q1_R )
#endif
    ...
    !$OMP MAP( from: U_R ) &
    !$OMP MAP( release: U0_R, T0_R, T1_R, Q1_R, uGE, uGF )
#elif defined(THORNADO_OACC)
    !$ACC EXIT DATA &
    !$ACC COPYOUT( U_R ) &
    !$ACC DELETE( U0_R, T0_R, T1_R, Q1_R, uGE, uGF )
#endif

  END SUBROUTINE Update_My_IMEX_PDARS
